...
bodefiles = ["D6 Network 500 to 6k Hz.csv","D6 8.orden Network 100 to 10k Hz v2.csv", "D6 8.orden Network 100 to 10k Hz v3.csv"]
dataLabel = ["4. ordens","8. ordens", "8. ordens v2"]
# bodeDiagram(bodefiles, dataLabel)



spektrumFiles = ["Data\D8 right tap 31bit spektrum 2k samples hearing.csv"]
dataLabel = ["31bit"]
